...
from ..data.data_extract import load_csv_data, load_json_data, attach_battery_from_csv, attach_timeseries_from_rts_csv
...
dat = attach_timeseries_from_rts_csv(
    ...
    ren_csvs={
        ...
        "csp": r"C:\Users\vdiazpa\Documents\quest_planning\quest_planning\seismic_model\datasets\RTS_data\DAY_AHEAD_Natural_Inflow.csv"},
